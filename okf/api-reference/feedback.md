...
resource: https://docs.suaempresa.com/api-reference/feedback/
tags:
  - api
  - portal
status: stable
...
sources:
  - id: repo
    resource: src/content/docs/api-reference/feedback.md
    title: src/content/docs/api-reference/feedback.md no repositório
...
Quando o sinal binário não basta, quem opera o portal tem a [observabilidade de leitura](/guides/observabilidade-de-leitura.md): busca sem resultado, abandono e jornada dizem *onde* o leitor travou, também sem guardar texto que ele escreveu.
...
- **[Gap Mining](/guides/lacunas-de-documentacao.md)** — voto negativo repetido é um dos sinais que sugerem lacuna.
- **[Self-healing](/guides/self-healing.md)** — como sinal, e **não** como gatilho de redação: uma página com votos negativos diz que o conteúdo existe e não serviu, e um agente reescrevendo por cima sem saber por quê costuma piorá-la.
