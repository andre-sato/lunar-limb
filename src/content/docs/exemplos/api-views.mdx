...
está no guia de [overlays e API Views](/guides/overlays-e-api-views/).
...
:::danger[O conflito que reprova é outro]
...
| --- | --- |
| [Overlays e API Views](/guides/overlays-e-api-views/) | Os dois overlays completos, a view empilhada, e o build das três efetivas |
| [Governança](/guides/governanca/) | `x-lunar.owner` e `purpose` em cada overlay |
| [Digital Twin](/guides/digital-twin/) | O motivo de as rotas internas ficarem na base |
| [Contratos](/guides/contratos-de-documentacao/) | Contrato testado contra a efetiva, não a base |
| [SDK](/guides/sdk/) | Um cliente por view, do mesmo contrato |

A Órbita não existe — ver a [visão geral da vitrine](/exemplos/). Os comandos e a
