...
estar na especificação: o [Digital Twin](/guides/digital-twin/) as usa para saber
...
a documentação, os [contratos](/guides/contratos-de-documentacao/), o
[SDK](/guides/sdk/) e o Explorer exatamente como a base alimentaria.

:::note[A base nunca é escrita]
...
pouco](/guides/governanca/). O critério é o mesmo, e aqui ele leva ao contrário:
...
é a mesma da [governança de páginas](/guides/governanca/): um artefato sem dono é
...
:::caution[Incompatível em relação à view, não à base]
...
- **Versionar a API.** Uma v2 com contrato diferente é outra especificação, não um
  recorte desta. Ver [versionamento](/guides/versionamento/).
