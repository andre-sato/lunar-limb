...
O voto vai para a [observabilidade nativa](/guides/observabilidade-de-leitura/), e para lugar nenhum além dela. Detalhes em [docs/feedback-de-pagina.md](https://github.com/andre-sato/lunar-limb/blob/master/docs/feedback-de-pagina.md).
