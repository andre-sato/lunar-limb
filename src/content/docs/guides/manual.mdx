...
O menu do topo é gerado a partir dessas pastas: cada uma vira um item, e as
páginas de dentro formam o submenu. Criar um arquivo já o publica — não há passo
de registro em lugar nenhum.
...
linguagem natural — em português, inglês ou espanhol — e responde em três
partes, nesta ordem:
