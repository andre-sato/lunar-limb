...
**Buscar na documentação** fica na barra lateral, aberto, e recolhe no título
quando você quiser espaço — a escolha acompanha a navegação. Nas páginas sem
barra lateral, como a capa, ele aparece como botão no cabeçalho.
